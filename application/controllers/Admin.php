...
class Admin extends CI_Controller
{
    ...
    public function cashiers()
    {
        ...
        $this->load->view('templates/admin_dashboard_header');
        $this->load->view('pages/cashier_list');
    }
    ...
    public function transaction_management()
    {
        ...
        $this->load->view('templates/admin_dashboard_header');
        $this->load->view('pages/transaction_list');
    }
    ...
    public function daily_reports()
    {
        ...
        $this->load->view('templates/admin_dashboard_header');
        $this->load->view('pages/daily_reports', $data);
    }
    ...
    public function customer_details()
    {
        ...
        $this->load->view('templates/admin_dashboard_header');
        $this->load->view('pages/customer_details');
    }
    ...
    function cashier_metrics() {
        ...
        $this->load->view('templates/admin_dashboard_header');
        $this->load->view('pages/cashier_metrics');
    }
